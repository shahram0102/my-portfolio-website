...
const Input = ({ formik, name, placeholder, type = "text" }) => {
  return (
    <div className="flex flex-col mb-4 items-start justify-start">
      <input
        className={`mb-2 text-xl shadow-[rgba(0 0 10px,0.8)] placeholder:text-gray-400 placeholder:text-sm text-blue-400 placeholder:font-thin   py-2 px-4 min-w-[400px] rounded-lg ${
